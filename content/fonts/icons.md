...
- from font file (for example .ttf) create vfs_fonts.js file (see how to [use custom fonts](/docs/0.1/fonts/custom-fonts-client-side/#1-create-a-new-vfs-fonts-js-containing-your-font-files))
